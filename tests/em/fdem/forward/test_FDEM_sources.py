...
class TestSimpleSourcePropertiesTensor(unittest.TestCase):
    def setUp(self):
        ...
        self.prob_e = fdem.Simulation3DElectricField(self.mesh, sigma=mapping)
        self.prob_b = fdem.Simulation3DMagneticFluxDensity(self.mesh, sigma=mapping)
        self.prob_h = fdem.Simulation3DMagneticField(self.mesh, sigma=mapping)
        self.prob_j = fdem.Simulation3DCurrentDensity(self.mesh, sigma=mapping)
